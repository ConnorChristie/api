...
public final class TradingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.vegaprotocol.vega.api.Trading.PrepareProposalRequest,
      io.vegaprotocol.vega.api.Trading.PrepareProposalResponse> getPrepareProposalMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "PrepareProposal",
      requestType = io.vegaprotocol.vega.api.Trading.PrepareProposalRequest.class,
      responseType = io.vegaprotocol.vega.api.Trading.PrepareProposalResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.vegaprotocol.vega.api.Trading.PrepareProposalRequest,
      io.vegaprotocol.vega.api.Trading.PrepareProposalResponse> getPrepareProposalMethod() {
    io.grpc.MethodDescriptor<io.vegaprotocol.vega.api.Trading.PrepareProposalRequest, io.vegaprotocol.vega.api.Trading.PrepareProposalResponse> getPrepareProposalMethod;
    if ((getPrepareProposalMethod = TradingServiceGrpc.getPrepareProposalMethod) == null) {
      synchronized (TradingServiceGrpc.class) {
        if ((getPrepareProposalMethod = TradingServiceGrpc.getPrepareProposalMethod) == null) {
          TradingServiceGrpc.getPrepareProposalMethod = getPrepareProposalMethod =
              io.grpc.MethodDescriptor.<io.vegaprotocol.vega.api.Trading.PrepareProposalRequest, io.vegaprotocol.vega.api.Trading.PrepareProposalResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "PrepareProposal"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.vegaprotocol.vega.api.Trading.PrepareProposalRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.vegaprotocol.vega.api.Trading.PrepareProposalResponse.getDefaultInstance()))
              .setSchemaDescriptor(new TradingServiceMethodDescriptorSupplier("PrepareProposal"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<io.vegaprotocol.vega.api.Trading.PrepareVoteRequest,
      io.vegaprotocol.vega.api.Trading.PrepareVoteResponse> getPrepareVoteMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "PrepareVote",
      requestType = io.vegaprotocol.vega.api.Trading.PrepareVoteRequest.class,
      responseType = io.vegaprotocol.vega.api.Trading.PrepareVoteResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.vegaprotocol.vega.api.Trading.PrepareVoteRequest,
      io.vegaprotocol.vega.api.Trading.PrepareVoteResponse> getPrepareVoteMethod() {
    io.grpc.MethodDescriptor<io.vegaprotocol.vega.api.Trading.PrepareVoteRequest, io.vegaprotocol.vega.api.Trading.PrepareVoteResponse> getPrepareVoteMethod;
    if ((getPrepareVoteMethod = TradingServiceGrpc.getPrepareVoteMethod) == null) {
      synchronized (TradingServiceGrpc.class) {
        if ((getPrepareVoteMethod = TradingServiceGrpc.getPrepareVoteMethod) == null) {
          TradingServiceGrpc.getPrepareVoteMethod = getPrepareVoteMethod =
              io.grpc.MethodDescriptor.<io.vegaprotocol.vega.api.Trading.PrepareVoteRequest, io.vegaprotocol.vega.api.Trading.PrepareVoteResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "PrepareVote"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.vegaprotocol.vega.api.Trading.PrepareVoteRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.vegaprotocol.vega.api.Trading.PrepareVoteResponse.getDefaultInstance()))
              .setSchemaDescriptor(new TradingServiceMethodDescriptorSupplier("PrepareVote"))
              .build();
        }
      }
    }
    return getPrepareVoteMethod;
  }
  ...
  public static abstract class TradingServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void prepareProposal(io.vegaprotocol.vega.api.Trading.PrepareProposalRequest request,
        io.grpc.stub.StreamObserver<io.vegaprotocol.vega.api.Trading.PrepareProposalResponse> responseObserver) {
     ...
     * </pre>
     */
    public void prepareVote(io.vegaprotocol.vega.api.Trading.PrepareVoteRequest request,
        io.grpc.stub.StreamObserver<io.vegaprotocol.vega.api.Trading.PrepareVoteResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getPrepareVoteMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.vegaprotocol.vega.api.Trading.PrepareProposalRequest,
                io.vegaprotocol.vega.api.Trading.PrepareProposalResponse>(
                  this, METHODID_PREPARE_PROPOSAL)))
          .addMethod(
            getPrepareVoteMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.vegaprotocol.vega.api.Trading.PrepareVoteRequest,
                io.vegaprotocol.vega.api.Trading.PrepareVoteResponse>(
                  this, METHODID_PREPARE_VOTE)))
          .addMethod(
  ...
  public static final class TradingServiceStub extends io.grpc.stub.AbstractAsyncStub<TradingServiceStub> {
    ...
    public void prepareVote(io.vegaprotocol.vega.api.Trading.PrepareVoteRequest request,
        io.grpc.stub.StreamObserver<io.vegaprotocol.vega.api.Trading.PrepareVoteResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getPrepareVoteMethod(), getCallOptions()), request, responseObserver);
    }
  ...
  public static final class TradingServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<TradingServiceBlockingStub> {
     ...
     * </pre>
     */
    public io.vegaprotocol.vega.api.Trading.PrepareProposalResponse prepareProposal(io.vegaprotocol.vega.api.Trading.PrepareProposalRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
     ...
     * </pre>
     */
    public io.vegaprotocol.vega.api.Trading.PrepareVoteResponse prepareVote(io.vegaprotocol.vega.api.Trading.PrepareVoteRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getPrepareVoteMethod(), getCallOptions(), request);
    }
  ...
  public static final class TradingServiceFutureStub extends io.grpc.stub.AbstractFutureStub<TradingServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<io.vegaprotocol.vega.api.Trading.PrepareProposalResponse> prepareProposal(
        io.vegaprotocol.vega.api.Trading.PrepareProposalRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<io.vegaprotocol.vega.api.Trading.PrepareVoteResponse> prepareVote(
        io.vegaprotocol.vega.api.Trading.PrepareVoteRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getPrepareVoteMethod(), getCallOptions()), request);
    }
  ...
  private static final int METHODID_PREPARE_PROPOSAL = 5;
  private static final int METHODID_PREPARE_VOTE = 6;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_PREPARE_PROPOSAL:
          serviceImpl.prepareProposal((io.vegaprotocol.vega.api.Trading.PrepareProposalRequest) request,
              (io.grpc.stub.StreamObserver<io.vegaprotocol.vega.api.Trading.PrepareProposalResponse>) responseObserver);
          break;
        case METHODID_PREPARE_VOTE:
          serviceImpl.prepareVote((io.vegaprotocol.vega.api.Trading.PrepareVoteRequest) request,
              (io.grpc.stub.StreamObserver<io.vegaprotocol.vega.api.Trading.PrepareVoteResponse>) responseObserver);
          break;
      ...
      synchronized (TradingServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getPrepareVoteMethod())
